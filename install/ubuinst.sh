...
wget https://github.com/ruck18/baseweb/raw/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/ruck18/baseweb/raw/main/install/verifatt.sh > /dev/null 2>&1
wget https://github.com/ruck18/baseweb/raw/main/install/verpweb > /dev/null 2>&1
wget https://github.com/ruck18/baseweb/raw/main/install/verweb > /dev/null 2>&1
wget https://github.com/ruck18/baseweb/raw/main/install/whatsapp.sh > /dev/null 2>&1
...
wget https://github.com/ruck18/baseweb/raw/main/install/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "https://github.com/ruck18/baseweb/raw/main/install/chave") &>/dev/null
